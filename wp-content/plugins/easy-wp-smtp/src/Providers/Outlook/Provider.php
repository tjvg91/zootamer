...
class Provider {
	 ...
	 * @var string
	 */
	private $dismissed_notice_key = 'easy_wp_smtp_microsoft_basic_auth_deprecation_notice_dismissed';
	...
	public function maybe_display_basic_auth_notice() {
		...
		$message = wp_kses(
			sprintf( /* translators: %1$s - documentation link. */
				__( 'Heads up! Microsoft is <a href="%1$s" target="_blank" rel="noopener noreferrer">discontinuing support for basic SMTP connections</a>. To continue using Outlook or Hotmail, switch to our Outlook mailer for uninterrupted email sending.', 'easy-wp-smtp' ),
