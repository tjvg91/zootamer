  ...
  _createClass(Siema, [{
    ...
    value: function buildSliderFrame() {
      if (this.innerElements.length <= this.perPage) {
        ...
        (_this$parentSelector$ = this.parentSelector.querySelector('.merchant-carousel-nav-next')) === null || _this$parentSelector$ === void 0 ? void 0 : _this$parentSelector$.remove();
        (_this$parentSelector$2 = this.parentSelector.querySelector('.merchant-carousel-nav-prev')) === null || _this$parentSelector$2 === void 0 ? void 0 : _this$parentSelector$2.remove();
        return false;
      }
        ...
        if (carouselEl.getAttribute('data-initialized') !== 'true') {
          ...
          var carousel = new Siema({
            ...
            onInit: function onInit() {
              ...
              this === null || this === void 0 ? void 0 : (_this$innerElements = this.innerElements) === null || _this$innerElements === void 0 ? void 0 : _this$innerElements.forEach(function (item) {
        ...
        setTimeout(function () {
          ...
          if (mini_cart_list !== null) {
            if ((mini_cart_list === null || mini_cart_list === void 0 ? void 0 : mini_cart_list.children.length) > 2) {
              mini_cart === null || mini_cart === void 0 ? void 0 : mini_cart.classList.remove('mini-cart-has-no-scroll');
              mini_cart === null || mini_cart === void 0 ? void 0 : mini_cart.classList.add('mini-cart-has-scroll');
            } else {
              mini_cart === null || mini_cart === void 0 ? void 0 : mini_cart.classList.remove('mini-cart-has-scroll');
              mini_cart === null || mini_cart === void 0 ? void 0 : mini_cart.classList.add('mini-cart-has-no-scroll');
            }
          }
          _this.build();
          onpageload = false;
...
merchant.carousel.domReady(function () {
  ...
  merchant === null || merchant === void 0 ? void 0 : (_merchant$carousel = merchant.carousel) === null || _merchant$carousel === void 0 ? void 0 : _merchant$carousel.init();
});
jQuery(document).on('photoSliderTriggered', function () {
  var _merchant$carousel2;
  merchant === null || merchant === void 0 ? void 0 : (_merchant$carousel2 = merchant.carousel) === null || _merchant$carousel2 === void 0 ? void 0 : _merchant$carousel2.init();
});